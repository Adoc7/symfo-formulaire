...
namespace JG\PlatformBundle\Validator;
...
class AntifloodValidator extends ConstraintValidator
{
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        // On vérifie si cette IP a déjà posté une candidature il y a au moins 15 secondes

        $isFlood = $this->em
            ->getRepository('JGPlatformBundle:Application')
            ->isFlood($ip, 15) // Bien entendu, il faudrait écrire cette méthode isFlood, c'est simple pour l'exemple
        ;
